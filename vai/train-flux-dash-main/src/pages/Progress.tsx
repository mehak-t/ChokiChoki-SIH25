...
const progressSteps = [
  'Validating fleet data integrity and AI model readiness',
  'Applying constraint weights with ML risk predictions',
  'AI-enhanced optimization for operational efficiency',
  'Route allocation with explainable AI insights',
  'Finalizing AI-enhanced schedule and generating explanations'
];
